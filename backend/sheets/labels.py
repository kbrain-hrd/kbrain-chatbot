...
LABELS: list[tuple[str, str, str, str, str]] = [
    ("문항", "?-S02-M03", "ask_grade", "3과목", "2세트 3과목 json 제출 범위"),
    ("문항", "?-S03-M03", "ask_grade", "3과목·오류제기", "본문 필터링인데 정답은 본문/제목"),
    ("문항", "?-S03-M02", "ask_grade", "", "제출파일 1개인지 2개인지"),
    ("문항", "?-S01-M02", "ask_grade", "검수전", "총인구수 정렬 오류 (현재 자료는 수정됨)"),
    ("문항", "?-S05-M01-Q02", "ask_grade", "공식정답오류", "불일치 사실 수 5 vs 10"),
    ("문항", "G-S03-M02", "answer", "검수전", "컬럼명 불일치 (등급 명시됨)"),
    ("문항", "?-S02-M03", "ask_grade", "3과목", "UI/UX가 채점 대상인지"),
    ("문항", "?-S03-M03", "ask_grade", "3과목", "json 파일 포함 여부"),
    ("문항", "?-S03-M02", "ask_grade", "검수전", "컬럼·빈 셀 확인 요청"),
    ("문항", "?-S03-M03", "ask_grade", "3과목·오류제기", "해설 결과 수 10 vs 8"),
    ("문항", "?-S05-M02", "ask_grade", "", "빈 셀이 없어 보임"),
    ("운영", "", "escalate", "재분류", "배포 플랫폼(cdsa.site) 허용 여부 — 제출 규정"),
    ("문항", "?-S01-M02", "ask_grade", "검수전", "총인구수 정렬 오류 (재질문)"),
    ("문항", "?-S03-M02", "ask_grade", "오류제기", "답안지·해설지 표기 오류"),
    ("문항", "?-S05-M01", "ask_grade", "", "첨부 파일 누락 여부"),
    ("문항", "", "escalate", "3과목·세트불명", "구현 메모 의미 + rss 링크 감점"),
    ("운영", "", "escalate", "재분류", "보안서약서 AI 사용 규정 해석"),
    ("운영", "", "escalate", "재분류", "시험 구성·웹캠 요건"),
    ("문항", "?-S01-M01", "ask_grade", "", "본문 길이 라운드 처리 기준"),
    ("문항", "?-S01-M03", "ask_grade", "3과목", "외부 리소스 구성 방식"),
